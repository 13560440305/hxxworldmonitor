...
export const COMMANDS: Command[] = [
  ...
  { id: 'panel:markets', keywords: ['markets', 'indices'], label: 'Jump to Markets', icon: '\u{1F4C8}', category: 'panels' },
  { id: 'panel:stocks', keywords: ['stocks', 'equities', 'stock market'], label: 'Jump to Stocks', icon: '\u{1F4CA}', category: 'panels' },
