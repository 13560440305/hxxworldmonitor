...
export class DeductionPanel extends Panel {
    ...
    constructor(getLatestNews?: () => NewsItem[]) {
        super({
            id: 'deduction',
            title: t('components.deduction.title'),
            infoTooltip: t('components.deduction.infoTooltip'),
        });
        ...
        this.inputEl = h('textarea', {
            ...
            placeholder: t('components.deduction.queryPlaceholder'),
            required: true,
            rows: 3,
        ...
        this.geoInputEl = h('input', {
            ...
            type: 'text',
            placeholder: t('components.deduction.geoPlaceholder'),
        }) as HTMLInputElement;

        this.submitBtn = h('button', {
            className: 'deduction-submit-btn',
            type: 'submit',
        }, t('components.deduction.analyze')) as HTMLButtonElement;
    ...
    private async handleSubmit(e: Event) {
        ...
        this.resultContainer.textContent = t('components.deduction.analyzing');
        ...
        try {
            ...
            if (resp.analysis) {
                ...
                const meta = h('div', { style: 'margin-top: 12px; font-size: 0.75em; color: #888;' },
                    t('components.deduction.generatedBy', {
                ...
                this.resultContainer.textContent = t('components.deduction.noAnalysis');
            }
        } catch (err) {
            console.error('[DeductionPanel] Error:', err);
            this.resultContainer.className = 'deduction-result error';
            this.resultContainer.textContent = t('components.deduction.error');
        } finally {
