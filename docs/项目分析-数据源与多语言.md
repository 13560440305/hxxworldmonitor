...
| **Relay 中继** | `WS_RELAY_URL`、`AISSTREAM_API_KEY`、`OPENSKY_CLIENT_ID`/`OPENSKY_CLIENT_SECRET`、`RELAY_SHARED_SECRET` | AIS 船舶 + OpenSky + RSS 代理 + Telegram OSINT | 自托管 `scripts/ais-relay.cjs`（详见 [AIS-RSS-RELAY.md](./AIS-RSS-RELAY.md)） |
